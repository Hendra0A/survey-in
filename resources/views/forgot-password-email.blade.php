							...
							<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td style="padding:0 35px;">
										<h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Hai
											{{ $name }}</h1>
										<span
										...
										<p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
											...
											ulang password, kamu dapat mengabaikan email ini. </p>
										<a href="https://survey.idekite.id/reset-password/{{ $token }};"
											style="background:#0d6efd;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:0.3rem;">Atur
											Ulang Password</a>
									</td>
								</tr>
								<tr>
