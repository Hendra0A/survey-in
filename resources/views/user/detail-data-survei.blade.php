        ...
        <div class="detail-data col-12 d-flex flex-column justify-content-center">
            <table class="detail col-12 mb-3">
                ...
                <tr>
                    ...
                    <td>
                        : Panjang = {{ ($data->dimensi_saluran_panjang_kanan!=0)?$data->dimensi_saluran_panjang_kanan.'
                        m' :'tidak ada' }} (kanan) dan {{
                        ($data->dimensi_saluran_panjang_kiri!=0)?$data->dimensi_saluran_panjang_kiri.' m' :'tidak ada'
                        }} (kiri)<br>
                        : Lebar = {{ ($data->dimensi_saluran_lebar_kanan!=0)?$data->dimensi_saluran_lebar_kanan.' m'
                        :'tidak ada' }} (kanan) dan {{
                        ($data->dimensi_saluran_lebar_kiri!=0)?$data->dimensi_saluran_lebar_kiri.' m' :'tidak ada' }}
                        (kiri)<br>
                        : Kedalaman = {{
                        ($data->dimensi_saluran_kedalaman_kanan!=0)?$data->dimensi_saluran_kedalaman_kanan.' m' :'tidak
                        ada' }} (kanan) dan {{
                        ($data->dimensi_saluran_kedalaman_kiri!=0)?$data->dimensi_saluran_kedalaman_kiri.' m' :'tidak
                        ada' }} (kiri)<br>
                    </td>
                </tr>
            ...
            <div class="tombol-detail col-12 d-flex justify-content-center">
                ...
                <a href="" class="text-decoration-none btn btn-warning m-2 text-white" style="border-radius: .5em;"><i
