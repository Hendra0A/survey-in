	...
	<div class="content">
		<div class="container">
			...
			<div class="content ps-3 pe-3">
				...
				@endif
				<form method="POST" action="tambah-data" enctype="multipart/form-data" class="form-tambah" autocomplete="off">
					@csrf
					...
					<div class="row row-cols-3">
						<div class="col-12 col-sm-6 mb-3">
							<label for="nama_gang" class="form-label fw-bold">Nama Gang dan Perumahan <sup
									class="text-danger">*</sup></label>
							<input type="text" class="form-control border-primary @error('nama_gang') is-invalid @enderror"
								style="border-radius: .5em;" id="nama_gang" name="nama_gang" value="{{ old('nama_gang') }}" required>
							@error('nama_gang')
					...
					<div class="col-12 mb-3">
						<label for="input-koordinat" class="form-label fw-bold d-block m-0 mb-2">Koordinat Depan Gang/Komplek <sup
								class="text-danger">*</sup> </label>
						<div class="col-12 d-flex">
							<button type="button" id="koordinat-depan"
								...
								style="border-radius: .5em; background: #3F4FC8;"><i class="fas fa-map-marker-alt m-0 pe-1"></i>Lokasi</button>
							<input type="text" class="form-control border-primary @error('no_gps_depan') is-invalid @enderror"
								style="border-radius: .5em;" id="input-koordinat-depan" name="no_gps_depan" value="{{ old('no_gps_depan') }}"
								required>
							@error('no_gps')
								<div id="validationServer03Feedback" class="invalid-feedback">
									{{ $message }}
					...
					<div class="col-12 mb-3">
						<label for="input-koordinat" class="form-label fw-bold d-block m-0 mb-2">Koordinat Belakang Gang/Komplek <sup
								class="text-danger">*</sup> </label>
						<div class="col-12 d-flex">
								...
								<div class="input-group m-1">
									<select class="form-select form-select border-primary @error('jenis_konstruksi_jalan_id') is-invalid @enderror"
										...
										@foreach ($jalan as $item)
											<option {{ old('jenis_konstruksi_jalan_id') == $item->id ? 'selected' : '' }} value="{{ $item->id }}">
												{{ $item->jenis }}</option>
										@endforeach
									</select>
							...
							<div class="kolom-data m-1" style="width: 30%;">
								...
								<div class="input-group m-1">
									<input type="number" step=".1" class="form-control border-primary @error('status_jalan') is-invalid @enderror"
										...
										value="{{ old('status_jalan') }}" id="status_jalan">
									<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">%</span>
									@error('status_jalan')
										<div id="validationServer03Feedback" class="invalid-feedback">
											{{ $message }}
										</div>
					...
					<!-- Dimensi Jalan Utama -->
					<div class="col-12 mb-3">
						<label for="" class="form-label d-block m-0 fw-bold mt-2">Dimensi Jalan Utama <sup
								class="text-danger">*</sup></label>
							...
							<div class="kolom-data m-1 col-sm-5">
								...
								<div class="input-group m-1">
									<input type="text" class="form-control border-primary @error('dimensi_jalan_panjang') is-invalid @enderror"
										...
										value="{{ old('dimensi_jalan_panjang') }}" required>
									<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
							...
							<div class="kolom-data m-1 col-sm-5">
								...
								<div class="input-group m-1">
									<input type="text" class="form-control border-primary @error('dimensi_jalan_lebar') is-invalid @enderror"
										...
										value="{{ old('dimensi_jalan_lebar') }}" required>
									<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
								...
								<div class="input-group m-1">
									<select class="form-select form-select border-primary" id="keadaan-saluran" autocomplete="off"
										...
										@foreach ($saluran as $item)
											<option {{ old('jenis_konstruksi_saluran_id') == $item->id ? 'selected' : '' }}
							...
							<div class="kolom-data m-1" style="width: 30%;">
								...
								<div class="input-group m-1">
									<input type="text"
										...
										style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1" name="status_saluran"
										value="{{ old('status_saluran') }}" id="status_saluran">
									<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">%</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													name="dimensi_saluran_panjang_kanan" value="{{ old('dimensi_saluran_panjang_kanan') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="dimensi_saluran_panjang_kiri" value="{{ old('dimensi_saluran_panjang_kiri') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="dimensi_saluran_lebar_kanan" value="{{ old('dimensi_saluran_lebar_kanan') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="dimensi_saluran_lebar_kiri" value="{{ old('dimensi_saluran_lebar_kiri') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
										...
										<div class="col-6 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="dimensi_saluran_kedalaman_kanan" value="{{ old('dimensi_saluran_kedalaman_kanan') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
										...
										<div class="col-6 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text"
													...
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="dimensi_saluran_kedalaman_kiri" value="{{ old('dimensi_saluran_kedalaman_kiri') }}">
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">m</span>
						...
						<div class="col-12 d-flex justify-content-between">
							<div class="kolom-data col-3">
								...
								<div class="input-group">
									<input type="text"
										...
										style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1" name="jumlah_rumah_layak"
										value="{{ old('jumlah_rumah_layak') }}" required>
									<span class="input-group-text p-1 border-0" style="background: #F3F8FF;" id="basic-addon1">unit</span>
							...
							<div class="kolom-data col-3">
								...
								<div class="input-group">
									...
									<span class="input-group-text p-1 border-0" style="background: #F3F8FF;" id="basic-addon1 required">unit</span>
							...
							<div class="kolom-data col-3">
								...
								<div class="input-group">
									<input type="text"
										...
										style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1" name="jumlah_rumah_kosong"
										value="{{ old('jumlah_rumah_kosong') }}" required>
									<span class="input-group-text p-1 border-0" style="background: #F3F8FF;" id="basic-addon1">unit</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text" class="form-control border-primary @error('jumlah_rumah_developer') is-invalid @enderror"
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="jumlah_rumah_developer" value="{{ old('jumlah_rumah_developer') }}" required>
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">Unit</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text" class="form-control border-primary @error('jumlah_rumah_swadaya') is-invalid @enderror"
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1"
													name="jumlah_rumah_swadaya" value="{{ old('jumlah_rumah_swadaya') }}" required>
												<span class="input-group-text border-0" style="background: #F3F8FF;" id="basic-addon1">Unit</span>
								...
								<div class="col-12 col-sm-6 mb-2">
									<div class="d-flex col-sm-12">
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<select class="form-select form-select border-primary" autocomplete="off" style="border-radius: .5em;"
													aria-label=".form-select example" name="pos_jaga">
								...
								<div class="col-12 col-sm-6 mb-2">
									<div class="d-flex col-sm-6">
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text" class="form-control border-primary @error('lantai_ruko_kanan') is-invalid @enderror"
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1" name="lantai_ruko_kanan"
													value="{{ old('lantai_ruko_kanan') }}">
												<span class="input-group-text p-1 border-0" style="background: #F3F8FF;" id="basic-addon1">lantai</span>
										...
										<div class="col-6 col-sm-12 ps-1 pe-1">
											...
											<div class="input-group m-1">
												<input type="text" class="form-control border-primary @error('lantai_ruko_kiri') is-invalid @enderror"
													style="border-radius: .5em;" aria-label="Username" aria-describedby="basic-addon1" name="lantai_ruko_kiri"
					...
					<div class="col-12 mb-3 ps-2">
						...
						<input type="text" class="form-control border-primary" style="border-radius: .5em;" id="input-imb" name="no_imb"
							value="{{ old('no_imb') }}">
					</div>
					<!-- Imb Pendahuluan -->
