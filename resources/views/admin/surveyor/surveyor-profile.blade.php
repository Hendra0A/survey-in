                                ...
                                <tbody class="isi-tabel">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            Survei Sukses
                                            @elseif($item->selesai - $item->target < 0) {{ $item->selesai -
                                                $item->target }} Gang dan Perumahan
                                                @endif
                                        </td>
                                    </tr>
                                    @endforeach
        ...
        <div class="biodata">
            ...
            <table class="bio">
                ...
                <tr>
                    ...
                    <td class="right-bio">:
                        {{ $profile_surveyor->tanggal_lahir === null ? $profile_surveyor->tanggal_lahir :
                        \Carbon\Carbon::parse($profile_surveyor->tanggal_lahir)->format('j F, Y') }}
                    </td>
                </tr>
                <tr>
                ...
                <tr id="tr-akhir">
                    ...
                    <td class="right-bio {{ $selesai - $target < 0 ? 'text-danger' : 'text-success' }} fw-bold">:
                        ...
                        Survei Komplit
                        @elseif($selesai - $target < 0) {{ $selesai - $target }} Gang dan Perumahan @endif </td>
                </tr>
            </table>
        </div>
    </div>
